...
instruction* instruction_by_opcode(uint_8 opcode)
{
...
static char* register_lookup[] = {"<NONE>",
                                  "A",
                                  "F",
                                  "B",
                                  "C",
...
void instruction_to_str(cpu_context* ctx, char* str)
{
  instruction* inst = ctx->cur_instruction;
