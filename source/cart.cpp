...
char* Cartridge::cart_lic_name()
{
  if (const char *cart_lic_name() {
...
bool Cartridge::cart_load(char* cart)
{
  ...
  context.header = (RomHeader*)(context.rom_data + 0x100);
